...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className={`w-full h-screen flex items-center justify-center bg-cover bg-center px-6 md:px-20 transition-opacity duration-700 ease-in ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
